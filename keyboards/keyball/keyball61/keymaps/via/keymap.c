...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_RSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_RBRC  ,              KC_NUHS, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_RSFT  ,
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , KC_7     , KC_8     , KC_9     , _______  ,                                  _______  , KC_DEL  , KC_UP    , KC_BSPC  , _______  , KC_F12   ,
